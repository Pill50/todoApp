...
export default function Filters() {
  ...
  const [filterPiorities, setFilterPiorities] = useState([]);
  ...
  return (
    <Row justify="center">
      ...
      <Col sm={24}>
        ...
        <Select mode="multiple" allowClear placeholder="Please select" style={{ width: "100%" }} value={filterPiorities} onChange={handlePriorityChange}>
